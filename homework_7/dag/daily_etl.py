...
from functions.greenplum import *
...
dag = DAG(
    ...
    start_date=datetime(2021,6,2,17),
...
out_of_stock_t4 = PythonOperator(
    task_id='load_to_gold_out_of_stock',
    python_callable=load_to_gold_out_of_stock,
    op_kwargs={'date':'{{ds}}'},
    dag=dag
)
...
for i in get_silver_tables():
    out_of_stock_t3 >> dummy4 >> operator_green(i, dag) >> dummy5 >> out_of_stock_t4
